...
final class RoutineService: ObservableObject {
    ...
    private let routineSelect = "*, profiles!user_id(id, nickname, avatar_url, is_official, deleted_at), routine_steps(id, routine_id, step_order, title, description, duration, created_at)"
